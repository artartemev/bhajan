          ...
          {showFilters && (
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                <div className="space-y-4 pt-4">
                    <div><Label className="text-sm font-medium mb-2 block">Author</Label><div className="flex gap-2 flex-wrap"><FilterButton label="Bhaktivinod Thakur" value="Bhaktivinod Thakur" selectedValues={selectedAuthors} onToggle={(v) => toggleFilter(v, selectedAuthors, setSelectedAuthors)} /><FilterButton label="Narottam Das Thakur" value="Narottam Das Thakur" selectedValues={selectedAuthors} onToggle={(v) => toggleFilter(v, selectedAuthors, setSelectedAuthors)} /></div></div>
